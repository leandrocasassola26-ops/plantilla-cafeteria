...
export default function Promos() {
  ...
  return <ClientShell active="promos">
    <section className="page-head"><small>BENEFICIOS MELO</small><h1>Sabores para disfrutar</h1><p>Conocé qué incluye cada propuesta y su precio final antes de pedir.</p></section>
