...
const modules = ["Inicio", "Comandas", "Mesas", "Reservas", "Clientes", "Menú", "Promociones", "Stock", "Caja", "Reportes", "Equipo", "Configuración"]
const icons = ["⌂", "▣", "□", "◷", "♧", "☕", "☆", "◇", "$", "↗", "◎", "⚙"]
